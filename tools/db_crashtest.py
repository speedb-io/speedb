...
def gen_narrow_cmd_params(args):
    ...
    params["use_put_entity_one_in"] = 0
    params["write_fault_one_in"] = 0
    params["cache_type"] = "lru_cache"
    params["cache_size"] = 8388608
    params["use_write_buffer_manager"] = 1
    params["db_write_buffer_size"] = 1024 * 1024
