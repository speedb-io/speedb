...
int main() {
...

  {
    ...
    s = db1->Get(ReadOptions(), db1->DefaultColumnFamily(), "key2", &pinnable_val);
 ...
 {
    PinnableSlice pinnable_val;
    s = db1->Get(ReadOptions(), db1->DefaultColumnFamily(), "key1", &pinnable_val);
    if (!s.IsNotFound()) {
      std::cout << s.ToString() << std::endl;
      return 1;
    }
  ...
  {
    PinnableSlice pinnable_val;
    s = db2->Get(ReadOptions(), db2->DefaultColumnFamily(), "key2", &pinnable_val);
    if (strcmp(pinnable_val.data(), "value") != 0) {
    std::cout << s.ToString() << std::endl;
    return 1;
    }
  ...
  {
    PinnableSlice pinnable_val;
    s = db2->Get(ReadOptions(), db2->DefaultColumnFamily(), "key1", &pinnable_val);
    if (!s.IsNotFound()) {
      std::cout << s.ToString() << std::endl;
      return 1;
    }
