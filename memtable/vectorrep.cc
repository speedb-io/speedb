...
class VectorRep : public MemTableRep {
 public:
  ...
  MemTableRep::Iterator* GetIterator(Arena* arena, bool part_of_flush = false) override;
...
MemTableRep::Iterator* VectorRep::GetIterator(Arena* arena, bool /*part_of_flush*/) {
  char* mem = nullptr;
  if (arena != nullptr) {
