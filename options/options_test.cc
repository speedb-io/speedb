...
class SharedOptionsSpeeDBTest : public testing::Test {};

TEST_F(SharedOptionsSpeeDBTest, SharedOptionsSpeeDBTest) {
...
TEST_F(SharedOptionsSpeeDBTest, EnableSpeeDBFeaturesCF) {
  ...
  cfo.EnableSpeedbFeaturesCF(&op1);
  ASSERT_OK(db1->CreateColumnFamily(ColumnFamilyOptions(), "new_cf", &cf));
