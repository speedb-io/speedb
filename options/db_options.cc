...
static std::unordered_map<std::string, OptionTypeInfo>
    db_immutable_options_type_info = {
        ...
        {"use_clean_single_delete_during_flush",
         {offsetof(struct ImmutableDBOptions, use_clean_single_delete_during_flush),
          OptionType::kBoolean, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},          
};
...
ImmutableDBOptions::ImmutableDBOptions(const DBOptions& options)
    : create_if_missing(options.create_if_missing),
      ...
      use_clean_single_delete_during_flush(options.use_clean_single_delete_during_flush) {
...
void ImmutableDBOptions::Dump(Logger* log) const {
  ...
  ROCKS_LOG_HEADER(log, "            Options.use_clean_single_delete_during_flush: %s",
